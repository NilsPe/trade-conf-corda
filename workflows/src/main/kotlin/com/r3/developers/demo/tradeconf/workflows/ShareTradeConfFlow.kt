...
class ShareTradeConfFlow: ClientStartableFlow {
    ...
    override fun call(requestBody: ClientRequestBody): String {
        ...
        try {
            ...
            val flowArgs = requestBody.getRequestBodyAs(jsonMarshallingService, ShareTradeConfStartArgs::class.java)
            ...
            val counterparty = memberLookup.lookup(MemberX500Name.parse(flowArgs.counterpartyName)) ?:
                throw CordaRuntimeException("MemberLookup can't find counterparty specified in flow arguments.")
            ...
            val txBuilder= ledgerService.createTransactionBuilder()
                ...
                .addOutputState(tradeConfState)
                .addCommand(TradeConfContract.Share())
                .addSignatories(tradeConfState.participants)
            ...
            return flowEngine.subFlow(FinalizeTradeSubFlow(signedTransaction, counterparty.name))
